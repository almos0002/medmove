 ...
 *
 * Imported only from the sign-in page, which itself only renders the
 * picker when `import.meta.env.DEV === true` — Vite tree-shakes this
 * module out of production bundles entirely.
 */
